...
infobox="${infobox}\"halloween\" (Halloween), \"xmas\" (Christmas), and \"strangerthings\" (Stranger Things).\n"
infobox="${infobox}This includes themes, music, splashscreens, and game videoloadingscreens.\n"
...
if [ -d "$HOME/tampo" ]; then #delete folder if it is there
	echo "$HOME/tampo Exists. Now Removing ..."
	sudo rm -r $HOME/tampo; fi
